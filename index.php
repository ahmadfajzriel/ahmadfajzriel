...
<html lang="id">
  <head>
    ...
    <style>
      #home {
        background-image: url(image/cars-kreak.jpg);
  ...
  <body>
    <nav class="navbar navbar-expand-lg " style="background-color: var(--bs-body-bg);">
      <div class="container">
        <a class="navbar-brand" href="#">Arl_Afj</a>
        <button
    ...
    <section id="home" class="bg-light py-5">
      <div class="container text-center">
        ...
        <h2>Di WebSite Karakter Cars</h2>
        <p class="lead">
      ...
      >
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="img/gallery 1.jpg" class="d-block w-100" alt="Gambar 1" />
          </div>
          <div class="carousel-item">
            <img src="img/gallery 2.jpg" class="d-block w-100" alt="Gambar 2" />
          </div>
          <div class="carousel-item">
            <img src="img/gallery 3.jpg" class="d-block w-100" alt="Gambar 3" />
          </div>
        </div>
        <button
      ...
      <div class="container">
        ...
        <div class="row align-items-center justify-content-center">
          ...
          <div class="col-md-6 text-center text-md-start">
            <p>A11.2023.15050</p>
            <h2>Ahmad Fajzriel Juliyarso</h2>
    ...
    <footer class="text-center py-3" style="background-color: var(--bs-body-bg);">
      ...
      <div class="footer">
        <p>&copy; MadRielSo. All Rights Reserved.</p>
      </div>
    </footer>
